...
<script type="text/javascript">
  ...
  _gaq.push(['_setDomainName', 'kitkat.no']);
...
<body <?php body_class(); ?>>
  ...
  <div id="header" class="shadow_overall">
    <div class="head_foot_center">
      ...
      <div id="info_head" class="shadow_overall"><p>&copy; <?php echo date("Y") ?> Ole A. kitkat // post@kitkat.no // Stjernelaget, Lagveien 21 // N-145o Nesoddtangen</p></div>
