  ...
  <?php the_post(); ?>
    <div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
      ...
      <div class="entry-meta">
        <p><abbr class="published" title="<?php the_time('Y-m-d\TH:i:sO') ?>"><?php the_time( get_option( 'date_format' ) ); ?></abbr> <?php edit_post_link( __( 'Edit', 'kitkat' ), "<span class=\"meta-sep\"> // </span>\n\t\t\t\t\t\t", "\n\t\t\t\t\t" ) ?>
        </p>
      </div>
    </div>
  </div>
  <div class="fb"><fb:like href="www.kitkat.no" send="true" layout="button_count" width="450" show_faces="false" action="recommend" font="lucida grande"></fb:like></div>
